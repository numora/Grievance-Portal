...
VALUES 
	...
	insert into provider(provider_id,provier_name,provider_speciality,provider_type) values (1,'Anthem','Anthem','Anthem');
	insert into provider(provider_id,provier_name,provider_speciality,provider_type) values (1,'Anthem Kaiser','Anthem Kaiser','Anthem Kaiser');
